        ...
        <div class="col-xs-12">
            <section class="panel">
                <header class="panel-heading">
                    <h2 class="panel-title">Nhập thông tin</h2>
                </header>
                <div class="panel-body">
                    ...
                    @endif
                    <form class="form-horizontal form-bordered" action="/admin/crud" method="post">
                        @csrf
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="inputDefault">eventName</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="inputDefault">bandNames</label>
                            <div class="col-md-6">
                                <input type="text" class="form-control" id="inputDefault" name="name">
                                @error('bandName')
                                <div class="text-danger">* {{ $message }}</div>
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="inputDefault">startDate</label>
                            <div class="col-md-3">
                                <input type="text" class="form-control" id="inputDefault" name="date">
                                @error('startDate')
                                <div class="text-danger">* {{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="inputDefault">endDate</label>
                            <div class="col-md-3">
                                <input type="text" class="form-control" id="inputDefault" name="date">
                                @error('endDate')
                                <div class="text-danger">* {{ $message }}</div>
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="inputDefault">ticketPrice</label>
                            <div class="col-md-3">
